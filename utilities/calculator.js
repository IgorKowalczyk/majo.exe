...
module.exports = async (message) => {
 ...
 // Lock
 let qac = new MessageButton().setLabel("AC").setID(calculator_clear_lock).setStyle("red").setDisabled();
 let qe1 = new MessageButton().setLabel("(").setID(calculator_e1_lock).setStyle("blurple").setDisabled();
 let qe2 = new MessageButton().setLabel(")").setID(calculator_e2_lock).setStyle("blurple").setDisabled();
 let quppercase = new MessageButton().setLabel("^").setID(calculator_uppercase_lock).setStyle("blurple").setDisabled();
 ...
 let qstar = new MessageButton().setLabel("x").setID(calculator_star_lock).setStyle("blurple").setDisabled();
 let qone = new MessageButton().setLabel("1️").setID(calculator_1_lock).setStyle("gray").setDisabled();
 let qtwo = new MessageButton().setLabel("2️").setID(calculator_2_lock).setStyle("gray").setDisabled();
 let qthree = new MessageButton().setLabel("3️").setID(calculator_3_lock).setStyle("gray").setDisabled();
 let qminus = new MessageButton().setLabel("-").setID(calculator_minus_lock).setStyle("blurple").setDisabled();
 let qzero = new MessageButton().setLabel("0️").setID(calculator_0_lock).setStyle("gray").setDisabled();
 let qdot = new MessageButton().setLabel(".").setID(calculator_dot_lock).setStyle("blurple").setDisabled();
 let qequal = new MessageButton().setLabel("=").setID(calculator_equal_lock).setStyle("green").setDisabled();
 let qplus = new MessageButton().setLabel("+").setID(calculator_plus_lock).setStyle("blurple").setDisabled();
 let qbackspace = new MessageButton().setLabel("⌫").setID(calculator_backspace_lock).setStyle("red").setDisabled();
 let qdestroy = new MessageButton().setLabel("DC").setID(calc_irrc_lock).setStyle("red").setDisabled();
 let qpercent = new MessageButton().setLabel("%").setID(calc_percent_lock).setStyle("blurple").setDisabled();
