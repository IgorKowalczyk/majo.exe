 ...
 connect() {
  this.connection.connect((err) => {
   if (err) {
    ...
    if (config.show_threadID) console.log(chalk.white.bold("> ") + chalk.blue.bold("[MYSQL]") + chalk.cyan.bold(" Connected to the MySQL server! Connection ID: ") + chalk.blue.bold.underline(this.connection.threadId));
   }
  });
 }
 setup() {
