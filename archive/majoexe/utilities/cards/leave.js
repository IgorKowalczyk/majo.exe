...
module.exports = async (client, member, channel) => {
 ...
 const image = `${process.cwd()}/src/img/auto_messages/leave.png`;
 ...
 const embed = new MessageEmbed() // Prettier
  ...
  .setDescription(`> ${client.bot_emojis.stopwatch} Joined server at <t:${moment(member.joinedAt).unix()}:D> (<t:${moment(member.joinedAt).unix()}:R>)`)
