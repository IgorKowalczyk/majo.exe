...
module.exports = async (client, interaction, args) => {
 try {
  if (!interaction.member.permissions.has("MANAGE_GUILD")) {
   return client.createSlashError(interaction, `${client.bot_emojis.error} | You can't pause giveaway. Missing permission: \`MANAGE_GUILD\``);
  }
  if (!interaction.member.permissions.has("MANAGE_MESSAGES")) {
   return client.createSlashError(interaction, `${client.bot_emojis.error} | You can't pause giveaway. Missing permission: \`MANAGE_MESSAGES\``);
  }
