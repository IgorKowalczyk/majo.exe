  ...
  try {
   ...
   if (!args[0]) {
    ...
    const embed = new MessageEmbed()
     ...
     .setDescription(`> Use the menu, or use ${client.process.env.DOMAIN ? `[\`/help [category]\`](${client.process.env.DOMAIN})` : `\`/help [category]\``} to view commands base on their category!\n\n`)
