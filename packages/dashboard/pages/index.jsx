 ...
 return (
  <Container>
   <div className="flex h-screen w-full flex-col items-center justify-center gap-4 bg-cover md:bg-shapes">
    ...
    <h1></h1>
    <h2 className="max-w-[600px] text-center font-inter text-xl text-[#939DB8]">Majo.exe will not only keep your server entertained but also assist you with moderation and many other things!</h2>
