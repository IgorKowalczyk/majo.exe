...
export function Login() {
 ...
 return (
  <>
   <a onClick={() => signIn("discord")} className="flex cursor-pointer items-center rounded bg-button-primary px-5 py-2 leading-6 text-white duration-200 hover:bg-button-primary-hover motion-reduce:transition-none">
