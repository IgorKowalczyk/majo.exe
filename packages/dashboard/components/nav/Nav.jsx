   ...
   <div className="ml-auto mr-4">
    {session ? (
     <div className="flex items-center">
      <Link href="/dashboard" className="flex cursor-pointer items-center rounded bg-button-secondary px-5 py-2 font-poppins leading-6 text-white duration-200 hover:bg-button-secondary-hover motion-reduce:transition-none">
        ...
        <Menu as="div" className="relative inline-block text-left">
         <div>
          <Menu.Button className="ml-4 flex cursor-pointer items-center gap-3 duration-200 motion-reduce:transition-none">
           {({ open }) => (
            <div className={`${open ? "opacity-80" : "hover:opacity-80"} flex h-10 select-none items-center rounded bg-button-secondary px-5 py-2 duration-200 hover:bg-button-secondary-hover motion-reduce:transition-none`}>
