module.exports = {
 ...
 dashboard: {
  ...
  receive_stats: true, // Recieve stats from bot via <domain>/dashboard/stats (NOTE: ONLY ENABLE THIS FEATURE IF YOU HOST YOUR BOT SEPARATELY!)
  status_page: {
 ...
 web: {
  ...
  ssl_certs: false, // SSL Certificates
