...
options: {
 ...
 static: {// Only if options.stype = static
   message: `tralalala`,
   type: "PLAYING", // PLAYING | STREAMING | LISTENING | WATCHING
  },
 dates: { // Special dates for change status [Date Format: MM-DD]. If null = no special dates. Note: special date 
  "02-14": [ // Array
   {
   ...
   {
    message: `I Love Wredny Ruchacz Arbuz ❤️ `,
    type: "PLAYING",
   }
  ],
  "05-13": [
