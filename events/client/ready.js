 ...
 client.ws.on('INTERACTION_CREATE', async interaction => {
  ...
  if(command == "majo") {
   const embed = new Discord.MessageEmbed()
    ...
    .setTitle(`<a:sucess:759354039242063903> Hi ${interaction.member.user.username}! I'm ${client.user.username}`, interaction.member.user.displayAvatarURL({ dynamic: true, format: 'png', size: 2048 }))
    .setColor("RANDOM")
