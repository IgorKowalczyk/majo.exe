...
export default {
 ...
 run: async (client, interaction, guildSettings) => {
  try {
   const inviteLink = `https://discord.com/oauth2/authorize/?permissions=${client.config.bot.permissions}&scope=${client.config.global.scopes}&client_id=${client.user?.id}`;
   const inviteLinkRoot = `https://discord.com/oauth2/authorize/?permissions=8&scope=${client.config.global.scopes}&client_id=${client.user?.id}`;
