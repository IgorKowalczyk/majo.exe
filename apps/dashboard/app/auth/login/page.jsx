    ...
    <div className="flex flex-row gap-4">
     {Object.values(providers).map((provider) => (
      <div key={provider.name}>
       <button onClick={() => signIn(provider.id, { scope: "session identity guilds" })} className="flex cursor-pointer items-center rounded bg-button-primary px-4 py-2 leading-6 text-white duration-200 hover:bg-button-primary-hover motion-reduce:transition-none">
