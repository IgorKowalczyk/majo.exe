...
export default async function Image(request) {
 ...
 return new ImageResponse(
  (
   ...
   >
    <img src={`${process.env.NEXTAUTH_URL}/assets/avatar.png`} style={{ width: "125px", height: "125px", marginBottom: "20px", borderRadius: "50%", boxShadow: "0px 0px 277px 3px #101110" }} />
    <div
     style={{
