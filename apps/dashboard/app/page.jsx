 ...
 return (
  <>
   <div className="before:md:bg-grid-[#fff] relative z-20 flex min-h-screen w-full items-center justify-center before:absolute before:z-10 before:h-full before:w-full before:opacity-5 before:grayscale">
    ...
    <div className="relative z-20 -mt-8 flex w-full justify-center gap-4 px-3 select-none flex-col items-center md:w-[90%]">
     <Link href={"/api/invite"} className="before:w-wit text-lg font-normal group relative -mt-4 flex h-8 cursor-pointer items-center justify-center rounded-full bg-gradient-to-tr from-neutral-700/80 via-neutral-700/80 to-[#111012]/80 p-px text-center text-neutral-300 duration-200 before:absolute before:inset-0 before:h-8 before:rounded-full before:bg-gradient-to-tr before:from-neutral-700 before:via-neutral-500 before:to-[#111012] before:opacity-0 before:duration-200 hover:before:opacity-100">
      <span className="from-black-10/50 relative mt-px flex h-full w-full items-center rounded-full bg-gradient-to-tr to-[#111012] px-6">
       ...
       <ArrowRightIcon className="ml-2 inline-block h-4 min-h-[14px] w-4 min-w-[14px] transition-all duration-200 group-hover:translate-x-1" />
      </span>
     </Link>
     <Header1 className={"text-fill-transparent mb-0 xl:!text-5xl 2xl:!text-7xl	justify-center bg-gradient-to-b from-white to-neutral-400 box-decoration-clone bg-clip-text text-center !font-black !leading-snug"}>The only one Discord Bot</Header1>
    ...
    <div className="min-h-[500px] hidden translate-y-1/2 z-10 absolute bottom-0 md:flex w-full flex-col items-center justify-center">
     <GlobeClient />
     <div className="bg-[#ddd] opacity-5 blur-3xl inset-0 absolute m-auto z-[-10] w-[580px] h-[580px] mt-[100px] rounded-full" />
    </div>
   </div>
   <div className="relative z-[600] bg-background-primary min-h-screen">
