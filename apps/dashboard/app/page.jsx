 ...
 return (
  <>
   <div className="min-h-screen w-full relative flex items-center justify-center before:grayscale z-20 before:md:bg-grid-[#fff] flex-col  before:opacity-5 before:w-full before:h-full before:absolute before:z-10">
    ...
    <div className="-mt-14 xl:w-4/5 md:w-[90%] z-20 relative flex flex-row items-center">
     <div className="flex flex-col gap-4 justify-start items-start w-1/2">
      ...
      <Header1 className={"text-start !justify-start !font-black"}>The only one Discord Bot</Header1>
      <h2 className="max-w-[680px] text-2xl text-white/70">Majo.exe will not only keep your server entertained but also assist you with moderation and many other things!</h2>
   ...
   <hr class="m-[0_auto] mb-8 h-[1px] w-full border-none px-8 duration-300 motion-reduce:transition-none bg-[linear-gradient(to_right,transparent,rgba(255,255,255,0.1)_50%,transparent)]" />
  </>
 );
}
