 ...
 <DefaultMenu.Item>
  <p
   ...
   className={clsx(
    ...
    "ui-active:text-white group my-1 flex w-full cursor-pointer items-center rounded-md p-2 text-sm font-normal text-gray-400 duration-200 motion-reduce:transition-none"
   )}
  >
   {children}
  </p>
