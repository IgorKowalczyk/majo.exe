  ...
  <>
   <div className="flex flex-col">
    <div className="flex flex-row items-center gap-4">
     {showSearch && <InputWithIcon icon={<MagnifyingGlassIcon className="h-5 w-5" />} placeholder="Search" alue={globalFilter || ""} onChange={(e) => setGlobalFilter(e.target.value)} className="h-10" />}
     {showControls && (
      <select
       value={pageSize}
       onChange={(e) => {
