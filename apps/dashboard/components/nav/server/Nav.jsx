...
export async function Nav({ theme }) {
 ...
 return (
  <nav className="bg-background-navbar md:bg-background-navbar/70 fixed z-[9999] flex w-full items-center border-b border-b-neutral-800 py-4 text-left shadow-lg md:backdrop-blur-[9px]">
   <SideMenuControl />
   <div
    className={clsx(
     {
