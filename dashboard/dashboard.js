...
console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(" Starting dashboard..."));

module.exports = async (client) => {
 console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(" Setting up dashboard main config..."));
 console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(` Dashboard credentials: \n* Domain: ${process.env.DOMAIN}\n* Port: ${process.env.PORT}\n* ID: ${process.env.ID}\n* G Analytics: ${process.env.ANALYTICS || "Not set"}`));
 ...
 console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(" Setting up dashboard endpoints..."));
 ...
 console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(" All dashboard process done... Starting in web"));
 app.listen(port, null, null, () => console.log(chalk.bold(gradient.morning("[HOST]")) + chalk.cyan(` Dashboard is up and running on port ${port}.`)));
};
