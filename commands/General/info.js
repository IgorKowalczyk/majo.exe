 ...
 run: async (client, message, args) => {
  try {
   ...
   const embed = new Discord.MessageEmbed() // Prettier()
    ...
    .addField("<:discordjs:756951296392560811> Discord.js", "```" + dependencies["discord.js"] + "```", true)
    .addField("<:cpu:856174395436171294> CPU", os.cpus()[0].model.substring( 0, os.cpus()[0].model.indexOf( "CPU" ) ) + " x" + osutils.countCPUs() + " (`" + osutils.cpuCount() + "` cores)", true)
